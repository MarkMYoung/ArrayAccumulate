$(document).ready( function()
{
	...
	QUnit.test( "Empty array without context tests", function( qUnit )
	{
		...
		let accumulateValue = array.accumulate( function empty_array_without_context_accumulator_left( result, each, n, every )
		{return( result );});
		qUnit.strictEqual( accumulateValue, undefined, "Empty array without context: 'accumulate' return value was 'undefined'." );
		let accumulateRightValue = array.accumulateRight( function empty_array_without_context_accumulator_right( result, each, n, every )
		{return( result );});
		...
		//	let reduceValue = (array.length > 0 ? array : ['default, default']).reduce( function(...){...});
		// ...or something even crazier	like this:
		//	let reduceValue = 'default, default';
		...
		qUnit.throws( 
			function()
			{
				let reduceValue = array.reduce( function empty_array_without_context_reducer_left( result, each, n, every )
				{return( result );});
			},
			TypeError,
		...
		qUnit.throws( 
			function()
			{
				let reduceRightValue = array.reduceRight( function empty_array_without_context_reducer_right( result, each, n, every )
				{return( result );});
			},
			TypeError,
	...
	QUnit.test( "Empty array with context tests", function( qUnit )
	{
		...
		let contextArg = {'callback':'context', 'accumulated':1,};
		let accumulateValue = array.accumulate( function( result, each, n, every )
		{
...
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=//
	QUnit.test( "Non-empty array without context tests", function( qUnit )
	{
		...
		let accumulateValue = array.accumulate( function non_empty_array_without_context_accumulator_left( result, each, n, every )
		...
		let accumulateRightValue = array.accumulateRight( function non_empty_array_without_context_accumulator_right( result, each, n, every )
		{return((result || 1) * each );});
	...
	QUnit.test( "Non-empty array with context tests", function( qUnit )
	{
		...
		let contextArg = {'callback':'context', 'accumulated':null,};

		contextArg.accumulated = 1;
		let accumulateValue = array.accumulate( function non_empty_array_with_context_accumulator_left( result, each, n, every )
		{
		...
		contextArg.accumulated = 1;
		let accumulateRightValue = array.accumulateRight( function non_empty_array_with_context_accumulator_right( result, each, n, every )
		{
		...
		contextArg.accumulated = 1;
		let reduceValue = array.reduce( function non_empty_array_with_context_reducer_left( result, each, n, every )
		{
		...
		contextArg.accumulated = 1;
		let reduceRightValue = array.reduceRight( function non_empty_array_with_context_reducer_right( result, each, n, every )
		{
